...
//				mChildIndex = xVelocity > 0 ? mChildIndex -1 : mChildIndex + 1;
				...
				mChildIndex = xVelocity > 0 ? (index == mChildIndex ? mChildIndex : mChildIndex - 1)  : 
					(index < mChildIndex || scrollX < 0 ? mChildIndex : mChildIndex + 1);
			} else {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if(chilCount == 0) {
			...
			measuredWidth = chilCount * childView.getMeasuredWidth();
			...
			final View childView = getChildAt(0);
			measuredWidth = childView.getMeasuredWidth() * chilCount;
